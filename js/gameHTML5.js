...
function Player(x, y, direction) {
  ...
  this.inventory = [
    new Bitmap('assets/images/knife.png', 319, 200),
    new Bitmap('assets/images/goo_hand.png', 320, 332)
  ];
...
function Map(size) {
  ...
  this.skybox = new Bitmap('assets/images/deathvalley_panorama.jpg', 4000, 1290);
  this.wallTexture = new Bitmap('assets/images/wall_texture.jpg', 1024, 1024);
  this.floorTexture = new Bitmap('assets/images/floor_texture.jpg', 391, 392);
  this.light = 0;
  this.objects = [];
}
...
function Camera(canvas, resolution, fov) {
  ...
  this.width = canvas.width = 1000; // = window.innerWidth;
  this.height = canvas.height = 500; // = window.innerHeight;
  ...
  document.addEventListener('keyup', this.onKey.bind(this, false), false);
  // console.log('width:' + this.width + ' height:' + this.height + ' resolution:' + this.resolution + ' spacing:' + this.spacing + ' range:' + this.range + ' lightrange:' + this.lightRange + ' scale:' + this.scale);
}
...
Camera.prototype.drawColumn = function (column, ray, angle, map) {
  ...
  for (var s = ray.length - 1; s >= 0; s--) {
    ...
    if (s === hit) {
      ...
      //   console.log('textureX:' + textureX + ' wallTexture.height:' + wallTexture.height);
      //  console.log(s, step, wall);
...
map.addObject({
  color: 'brown',
  texture: new Bitmap('assets/images/monsters.png', 64, 64),
  height: 1,
  width: 1,
  floorOffset: 0,
  speed: .1,
